		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Eroare',
					'Contul tău nu îndeplinește cerințele pentru a utiliza această facilitate. <a class="whiteLink" href="https://help.steampowered.com/ro/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Vizitează Asistenţa Steam</a> pentru mai multe informaţii.'
				);
				break;
			case 15:
