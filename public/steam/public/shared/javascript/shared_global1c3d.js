	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 15:
				...
				break;
			default:
				ShowAlertDialog( 'Грешка', 'Имаше грешка, докато обработвахме заявката Ви: ' + responseJSON.success );
				break;
		}
	} );
	return false;
