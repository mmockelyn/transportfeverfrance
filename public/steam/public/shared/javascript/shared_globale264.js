	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 15:
				...
				break;
			default:
				ShowAlertDialog( 'Σφάλμα', 'Υπήρξε ένα σφάλμα κατά την επεξεργασία του αιτήματός σας: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Ενδεικτικά προϊόντα', 'Παρακαλούμε περιμένετε ενώ βρίσκουμε μερικά ενδεικτικά προϊόντα...' );
