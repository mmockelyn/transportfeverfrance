		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'ข้อผิดพลาด',
					'บัญชีของคุณไม่ผ่านความต้องการขั้นต่ำที่จะใช้คุณสมบัตินี้  <a class="whiteLink" href="https://help.steampowered.com/th/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">เยี่ยมชมฝ่ายสนับสนุน Steam</a> สำหรับข้อมูลเพิ่มเติม'
				);
				break;
			case 15:
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'กรุณารอสักครู่', 'กำลังกลับไปยังที่คุณอยู่ล่าสุดบนหน้านี้...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
{
	var waitDialog = ShowBlockingWaitDialog( 'ผลิตภัณฑ์ตัวอย่าง', 'กรุณารอสักครู่ในขณะที่เราค้นหาผลิตภัณฑ์ตัวอย่าง...' );
