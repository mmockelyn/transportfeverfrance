		...
		$SelectBox.append(
			$J('<option/>', {value: "french"} ).text( 'Français' )
				...
				$J('<option/>', {value: "english"} ).text( 'English (Anglais)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español - España (Espagnol - Espagne)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "latam"} ).text( 'Español-Latinoamérica (Espagnol - Amérique latine)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (Polonais)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Portugais)' )
			);
					$SelectBox.append(
