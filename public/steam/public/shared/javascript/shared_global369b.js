...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Lỗi',
					'Tài khoản của bạn không đáp ứng đủ yêu cầu để dùng tính năng này. <a class="whiteLink" href="https://help.steampowered.com/vn/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Ghé thăm trang hỗ trợ Steam</a> để biết thêm thông tin.'
				);
				break;
			case 15:
