...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( '자녀 보호로 돌아가기',
		'정말로 자녀 보호 상태로 돌아가고 싶으신가요?',
		'자녀 보호로 돌아가기'
	).done( function() {
		ShowBlockingWaitDialog( '자녀 보호로 돌아가기' );
