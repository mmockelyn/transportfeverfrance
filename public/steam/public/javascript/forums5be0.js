...
var CForum = Class.create( {
	...
	SubscribeToForum: function()
	{
		...
		new Ajax.Request( this.GetActionURL( 'subscribe' ), {
			...
			onFailure: function() { ShowForumSuccessDialogWithDetailTitle( 'สมัครสมาชิกฟอรัม', 'ตรวจพบข้อผิดพลาดในการสมัครสมาชิกฟอรัมนี้', 'กรุณาลองใหม่อีกครั้งภายหลัง' ); },
			onComplete: this.OnAJAXComplete.bind( this )
		});
	},
	...
	UnsubscribeFromForum: function()
	{
		...
		new Ajax.Request( this.GetActionURL( 'unsubscribe' ), {
			...
			onFailure: function() { ShowForumSuccessDialogWithDetailTitle( 'ยกเลิกการสมัครสมาชิกฟอรัม', 'ตรวจพบข้อผิดพลาดในการยกเลิกการสมัครสมาชิกจากฟอรัมนี้', 'กรุณาลองใหม่อีกครั้งภายหลัง' ); },
			onComplete: this.OnAJAXComplete.bind( this )
		});
	}
...
{
	ShowConfirmDialog('ทำเครื่องหมายเป็นสแปม ',
...
CForumTopic = Class.create( {
	...
	OnModeratorActionFailed: function( transport )
	{
		...
		{
			ShowForumSuccessDialog( '', 'ล้มเหลวในการแก้ไขกระทู้ กรุณาลองใหม่อีกครั้งภายหลัง' );
		}
	},
	...
	Subscribe: function( fnExternalOnSuccess )
	{
		if ( g_rgForumTopicCommentThreads[ this.m_gidForumTopic ] )
		{
			var fnSuccess = function() {
				ShowForumSuccessDialogWithDetailTitle( 'สมัครสมาชิกการสนทนานี้', 'คุณได้สมัครสมาชิกการสนทนานี้แล้ว', 'คุณจะได้รับการแจ้งเตือนความเห็นใหม่เมื่อมีคนตอบการสนทนานี้' );
				fnExternalOnSuccess();
			};
			var fnFail = ShowForumSuccessDialog.bind( null, 'สมัครสมาชิกการสนทนานี้', 'เราขออภัย เราไม่สามารถสมัครสมาชิกการสนทนานี้ได้ กรุณาลองใหม่อีกครั้งภายหลัง');
	...
	Unsubscribe: function( fnExternalOnSuccess )
	{
		...
		{
			var fnSuccess = function() {
				ShowForumSuccessDialogWithDetailTitle( 'ยกเลิกการสมัครสมาชิกการสนทนานี้', 'คุณได้ยกเลิกการสมัครสมาชิกการสนทนานี้แล้ว', 'คุณจะไม่ได้รับการแจ้งเตือนความเห็นจากการสนทนานี้อีกต่อไป' );
				fnExternalOnSuccess();
			};
			var fnFail = ShowForumSuccessDialog.bind( null, 'ยกเลิกการสมัครสมาชิกการสนทนานี้', 'เราขออภัย เราไม่สามารถยกเลิกการสมัครสมาชิกจากการสนทนานี้ได้ กรุณาลองใหม่อีกครั้งภายหลัง');
...
function ForumBulkLock( strName, rgForumTopicGIDs, bUnlock )
{
	BulkModerate( strName, rgForumTopicGIDs, 'locked', !bUnlock)
		.done( function( data ) {
			if ( bUnlock )
				ShowAlertDialog( 'ปลดล็อค', 'หัวข้อที่เลือกถูกปลดล็อค' );
			else
				ShowAlertDialog( 'ล็อค', 'หัวข้อที่เลือกถูกล็อค' );
		});
}
...
function ForumBulkSpam( strName, rgForumTopicGIDs )
{
	...
	BulkModerate( strName, rgForumTopicGIDs, 'markspam', true )
		.done( function( data ) {
			ShowAlertDialog( 'ทำเครื่องหมายเป็นสแปม', 'หัวข้อที่เลือกถูกลบและผู้สร้างได้ถูกแบนแล้ว' );
		});
});
}
...
function BulkModerate( strName, rgForumTopicGIDs, flag, value )
{
	...
	return deferred.fail( function() {
		ShowAlertDialog( 'ข้อผิดพลาด', 'พบข้อผิดพลาดในการประมวลผลคำร้องของคุณในบางส่วนหรือทั้งหมด กรุณาตรวจสอบว่าคุณได้ผลลัพธ์ตามที่ต้องการ' );
	}).always( function() {
...
function Forum_BanOrWarnUser( clanid, gidForum, gidTopic, gidComment, accountIDTarget, bWarning )
{
	...
	$J.get( 'https://steamcommunity.com/gid/' + clanid + '/banwarnuserdialog', {
		...
		else
		{
			Modal.done( function() {
				...
				$J.post(
					...
					ShowAlertDialog( 'เตือนผู้ใช้', ban_response.message ? ban_response.message : 'ผู้ใช้นี้ได้รับการเตือนเรียบร้อยแล้วสำหรับโพสต์ของเขา' );
				}).fail( function( jqxhr ) {
					var ban_response = V_ParseJSON( jqxhr.responseText );
					ShowAlertDialog( 'เตือนผู้ใช้', ban_response.message ? ban_response.message : 'เราได้ตรวจพบข้อผิดพลาดในการเตือนผู้ใช้นี้ กรุณาลองใหม่อีกครั้งภายหลัง' );
				});
			});
		}
		...
		if ( !bWarning ) {
			...
			ShowAlertDialog( 'เตือนผู้ใช้', 'เราได้ตรวจพบข้อผิดพลาดในการเตือนผู้ใช้นี้ กรุณาลองใหม่อีกครั้งภายหลัง' );
		}
	});
}
	...
	$modal.done( function( ) {
		...
		$J.post('https://steamcommunity.com/gid/' + clanid + '/sendprivatemessage/', rgParams )
			.done( function ( response ) {
				...
				{
					ShowAlertDialog( 'ข้อผิดพลาด', 'ตรวจพบข้อผิดพลาดในการส่งข้อความส่วนตัวนี้ กรุณาลองใหม่อีกครั้ง' + '(' + response.success + ')' );
				}
			});
	} );
