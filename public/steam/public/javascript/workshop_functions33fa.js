...
function validateFields()
{
		...
		try
	{
		...
		{
			errorString += 'Te rugăm să introduci un nume valid pentru deținătorul contului bancar (trebuie să corespundă cu informaţiile băncii).<br/>';
		}
...
function SaveWorkshopServiceProviders( publishedFileID )
{
	...
	$J.post( 'https://steamcommunity.com/sharedfiles/ajaxsetserviceprovidersplits', {
		...
		{
			case 14:
				ShowAlertDialog( 'Eroare', 'Nu poți alege o organizație terță care este şi colaborator al obiectului tău.' );
				break;
			default:
