...
function ValidateUserPaymentInfo( baseURL )
{
		...
		try
	{
		...
		{
			errorString += 'Por favor, introduce una ciudad válida.<br/>';
		}
...
function validateFields()
{
		...
		try
	{
		...
		{
			errorString += 'Por favor, introduce una dirección de email válida.<br/>';
		}
		...
		{
			errorString += 'Por favor, introduce una ciudad válida para tu entidad bancaria.<br/>';
		}
