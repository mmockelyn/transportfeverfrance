...
var CCommentThread = Class.create( {
	...
	MarkSpam: function( gidComment, authorAccountID, fnOnSuccess )
	{
		...
		var dialog = ShowConfirmDialog( 'Отметить как спам', 'Автор будет заблокирован в сообществе, и все его комментарии будут удалены. Наша система проанализирует этот комментарий, чтобы скрывать подобный контент автоматически. Вы уверены, что хотите сделать это?', 'Отметить как спам' );
