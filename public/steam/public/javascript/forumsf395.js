...
{
	ShowConfirmDialog('Označit jako spam ',
...
function ForumBulkSpam( strName, rgForumTopicGIDs )
{
	...
	BulkModerate( strName, rgForumTopicGIDs, 'markspam', true )
		.done( function( data ) {
			ShowAlertDialog( 'Označit jako spam', 'Vybraná témata byla smazána a na jejich autory byl uvalen ban.' );
		});
});
}
...
{
	ShowConfirmDialog('Zabanovat komentátory ',
	'Touto akcí uvalíte ban v komunitě (nebo jejich účty označíte jako odcizené) na uživatele, kteří ve vybraných vláknech zanechali více než daný počet komentářů. Opravdu chcete pokračovat?',
	'Zabanovat komentátory'
).done ( function() {
