...
{
	ShowConfirmDialog('Marquer comme indésirable ',
...
function ForumBulkSpam( strName, rgForumTopicGIDs )
{
	...
	BulkModerate( strName, rgForumTopicGIDs, 'markspam', true )
		.done( function( data ) {
			ShowAlertDialog( 'Marquer comme indésirable', 'Les sujets sélectionnés ont été supprimés et leurs auteurs ont été bannis.' );
		});
});
}
