		...
		try
	{
				...
				if ( $J( "#firstname").length != 0 )
		{
			...
			else
			{
				if ( !IsValidRequiredField( "#firstname", gValidFieldAlphaNumericRegex ) )
				{
					errorString += 'Ole hyvä ja anna kelpaava etunimi.<br/>';
				}
				if ( !IsValidRequiredField( "#lastname", gValidFieldAlphaNumericRegex ) )
				{
					errorString += 'Ole hyvä ja anna kelpaava sukunimi.<br/>';
				}
			}
		}
		...
		{
			errorString += 'Ole hyvä ja anna kelpaava osoitteesi.<br/>';
		}
		if ( !IsValidRequiredField( "#city", gValidFieldAlphaNumericRegex ) )
		{
			errorString += 'Ole hyvä ja anna kelpaava kaupunkisi.<br/>';
		}
		if ( $('country').value == 'US' || $('country').value == 'UA' )
		{
			if ( !IsValidRequiredField( "#zip", gValidFieldAlphaNumericRegex ) )
			{
				errorString += 'Ole hyvä ja syötä kelpaava postinumerosi.<br/>';
			}
		}
		if ( $( 'phone' ).value.length < 1 )
		{
			errorString += 'Syötä puhelinnumerosi, suuntanumero mukaan lukien.<br/>';
		}
	}
	catch(e)
	{
...
function validateFields()
{
		...
		try
	{
		...
		{
			errorString += 'Ole hyvä ja anna kelpaava sähköpostiosoitteesi.<br/>';
		}
		...
		{
			errorString += 'Ole hyvä ja anna kelpaava pankkisi nimi.<br/>';
		}
		if ( !IsValidRequiredField( "#bankaccountholdername", gValidFieldAlphaNumericRegex ) )
		{
			errorString += 'Syötä kelpaava pankkitilin haltijan nimi (täytyy vastata pankin tietoja).<br/>';
		}

				if ( !IsValidRequiredField( "#bankaddress1", gValidFieldAlphaNumericRegex ) )
		{
			errorString += 'Ole hyvä ja anna kelpaava pankkisi osoite.<br/>';
		}
		if ( !IsValidRequiredField( "#bankcity", gValidFieldAlphaNumericRegex ) )
		{
			errorString += 'Ole hyvä ja anna kelpaava pankkisi kaupunki.<br/>';
		}
		if ( $('bankcountry').value == 'US' || $('bankcountry').value == 'UA' )
		{
			if ( $( 'bankzip' ).value.length < 1 )
			{
				errorString += 'Ole hyvä ja anna kelpaava pankkisi zip- tai postikoodi.<br/>';
			}
		}

				if ( $( 'bankaccountnumber' ).value.length < 1 && !IsIBANCountry( $('bankcountry').value ) )
		{
			errorString += 'Ole hyvä ja anna tilinumerosi.<br/>';
		}
		if ( $( 'bankcountry' ).value == 'US' )
		{
			$('bankiban').value = '';
		...
		else if ( IsIBANCountry( $('bankcountry').value ) )
		{
			...
			{
				errorString += 'Ole hyvä ja anna pankkisi IBAN.<br/>';
			}
