    ...
    init: function() {
        document.getElementById("kt_modal_sign_out_sesions").addEventListener("click", (t => {
            ...
            n.addEventListener("click", (t => {
                t.preventDefault(), n.setAttribute("data-kt-indicator", "on"), n.disabled = !0, setTimeout((function() {
                ...
                n.preventDefault(), Swal.fire({
                    ...
                    n.value ? t.reset() : "cancel" === n.dismiss && Swal.fire({
