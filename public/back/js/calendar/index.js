    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            let calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                buttonIcons: false,
                weekNumbers: true,
                navLinks: !0, // can click day/week names to navigate views
                selectable: !0, // can click day/week names to navigate views
                selectMirror: !0,
                editable: !0,
            ...
            calendar.render(), r = flatpickr(o, {
                ...
                t.preventDefault(), Swal.fire({
                    text: "Êtes vous sur de vouloir du supprimer l'évènement ?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                ...
                e.preventDefault(), Swal.fire({
                    text: "êtes-vous sur de vouloir annuler le formulaire ?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    e.value ? (f.reset(), u.hide()) : "cancel" === e.dismiss && Swal.fire({
                        text: "La création de votre évènement à été annuler",
                        icon: "error",
                        buttonsStyling: !1,
