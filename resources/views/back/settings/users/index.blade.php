            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            ...
                            <!--begin::Input group-->
                            <div class="mb-10">
                                <label class="form-label fs-6 fw-bold">Authentification double facteur:</label>
                                <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Selectionner..." data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true">
                                    <option></option>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="reset" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="reset">Réinitialiser</button>
                                <button type="submit" class="btn btn-primary fw-bold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter">Appliquer</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Content-->
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                        ...
                        <!--end::Svg Icon-->Ajouter un utilisateur</button>
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                <div class="d-flex justify-content-end align-items-center d-none" data-kt-user-table-toolbar="selected">
                    <div class="fw-bolder me-5">
                        <span class="me-2" data-kt-user-table-select="selected_count"></span>Selectionner</div>
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">Export des utilisateur</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">Ajout d'un utilisateur</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{ route('api.back.settings.user.create') }}" method="POST">
                                    @csrf
                                    <!--begin::Scroll-->
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-bold fs-6 mb-2">Nom d'utilisateur (pseudo)</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Pseudo de l'utilisateur" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                        <div class="fw-bolder text-gray-800">Utilisateur</div>
                                                        <div class="text-gray-600">Accès au fonction principal du site.<br>Il n'a pas accès au panel administrateur</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Radio-->
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                        ...
                                                        <div class="text-gray-600">Accès à toutes les fonction du site y compris au panel administrateur</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Radio-->
        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Authentificator</th>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="{{ route('back.settings.users.show', $user->id) }}">
                                @if($user->avatar == null)
                                    <div class="symbol-label">{{ \Illuminate\Support\Str::limit($user->name, 1, '') }}</div>
                                @else
                                    <div class="symbol-label">
                                        <img src="/storage/files/shares/avatar/{{ $user->avatar }}" alt="{{ $user->name }}" class="w-100" />
                                    </div>
                                @endif
                            </a>
                        </div>
                        ...
                        <div class="d-flex flex-column">
                            <a href="{{ route('back.settings.users.show', $user->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $user->name }}</a>
                    ...
                    <!--end::User=-->
                    <!--begin::Role=-->
                    <td>{{ \App\Helpers\Format::formatUserGroup($user->group) }}</td>
                    <!--end::Role=-->
                    <!--begin::Last login=-->
                    <td>
                        <div class="badge badge-light fw-bolder">
                            @if($user->last_seen)
                                @if($user->last_seen >= now()->subDay())
                                    {{ $user->last_seen->diffForHumans() }}
                                @else
                                    {{ $user->last_seen->format('d/m/Y') }}
                                @endif
                            @endif
                        </div>
                    </td>
                    ...
                    <td>
                        @if($user->two_factor_secret)
                            <div class="badge badge-light-success fw-bolder">Activer</div>
                        @endif
                    </td>
                    <!--end::Two step=-->
                    <!--begin::Joined-->
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="{{ route('back.settings.users.show', $user->id) }}" class="menu-link px-3">Voir</a>
                            </div>
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
...
@section("script")
    ...
    <script src="/back/js/settings/users/index.js"></script>
@endsection
