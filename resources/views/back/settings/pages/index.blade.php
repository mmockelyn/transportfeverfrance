                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <a href="{{ route('page', $page->slug) }}" class="menu-link px-3" target="_blank">Aperçu</a>
                                </div>
                                <div class="menu-item px-3">
                                    <a href="{{ route('back.settings.pages.edit', $page->id) }}" class="menu-link px-3">Editer</a>
                                </div>
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 deletePage" data-id="{{ $page->id }}">
