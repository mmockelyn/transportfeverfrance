        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Administration du wiki
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1"><strong>Article: </strong>{{ $wiki->title }}</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="list-group">
                        <a href="{{ route('back.wiki.show', $wiki->id) }}" class="list-group-item list-group-item-action active" aria-current="true">Vue Général</a>
                        <a href="{{ route('back.wiki.edit', $wiki->id) }}" class="list-group-item list-group-item-action">Edition</a>
