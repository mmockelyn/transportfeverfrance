...
@section("style")
    <link href="/back/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
@endsection
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Administration
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Calendrier</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="#" type="button" class="btn btn-flex btn-primary" data-kt-calendar="add">
                    ...
                    <!--end::Svg Icon-->Ajouter un évènement</a>
            </div>
        </div>
        <!--end::Card header-->
        <!--begin::Card body-->
                ...
                <form class="form" action="#" id="kt_modal_add_event_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="fv-row mb-9">
                            <!--begin::Label-->
                            <label class="fs-6 fw-bold required mb-2">Nom de l'évènement</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="fv-row mb-9">
                            ...
                            <label class="form-check form-check-custom form-check-solid">
                                ...
                                <span class="form-check-label fw-bold" for="kt_calendar_datepicker_allday">Jour entier</span>
                            </label>
                            <!--end::Checkbox-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row row-cols-lg-2 g-10">
                            <div class="col">
                                <div class="fv-row mb-9">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold mb-2 required">Date de début</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                            ...
                            <div class="col" data-kt-calendar="datepicker">
                                <div class="fv-row mb-9">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold mb-2">Heure de début</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                        ...
                        <div class="row row-cols-lg-2 g-10">
                            <div class="col">
                                <div class="fv-row mb-9">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold mb-2 required">Date de fin</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                            ...
                            <div class="col" data-kt-calendar="datepicker">
                                <div class="fv-row mb-9">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold mb-2">Heure de fin</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_add_event_cancel" class="btn btn-white me-3">Annuler</button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="button" id="kt_modal_add_event_submit" class="btn btn-primary">
                            <span class="indicator-label">Soumettre</span>
                            <span class="indicator-progress">Veuiller patientez...
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header border-0 justify-content-end">
                    <!--begin::Edit-->
                    <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Editer l'évènement" id="kt_modal_view_event_edit">
                    ...
                    <!--end::Edit-->
                    <!--begin::Edit-->
                    <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Supprimer l'évènement" id="kt_modal_view_event_delete">
                    ...
                    <!--end::Edit-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-color-gray-500 btn-active-icon-primary" data-bs-toggle="tooltip" title="Annuler" data-bs-dismiss="modal">
                        <!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
                        <span class="svg-icon svg-icon-1">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
								<g transform="translate(12.000000, 12.000000) rotate(-45.000000) translate(-12.000000, -12.000000) translate(4.000000, 4.000000)" fill="#000000">
                ...
                <div class="modal-body pt-0 pb-20 px-lg-17">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="fs-6">
                            <span class="fw-bolder">Début</span>
...
@section("script")
    <script src="/back/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
    <script src="/back/js/calendar/index.js"></script>
@endsection
