...
@section("content")
        ...
        <div class="col-xl-3">
            <a href="#" class="card bg-body hoverable mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-black fw-bolder fs-2 mb-2 mt-5 saleSoldeYear">0,00 €</div>
                    <div class="fw-bold text-black">Ventes Annuel</div>
                </div>
                <!--end::Body-->
            </a>
            <a href="#" class="card bg-body hoverable mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-black fw-bolder fs-2 mb-2 mt-5 saleSoldeMonthly">0,00 €</div>
                    <div class="fw-bold text-black">Ventes Mensuel</div>
                </div>
                <!--end::Body-->
            </a>
            <a href="#" class="card bg-body hoverable mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-black fw-bolder fs-2 mb-2 mt-5 saleSoldeDay">0,00 €</div>
                    <div class="fw-bold text-black">Ventes Journaliers</div>
                </div>
                <!--end::Body-->
            </a>
        </div>
    ...
    <div class="modal fade" tabindex="-1" id="edit_sale">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
