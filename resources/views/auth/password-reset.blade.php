    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-size1: 100% 50%; background-image: url({{ asset('back/assets/media/misc/outdoor.png') }})">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <div class="w-lg-550px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
                <!--begin::Form-->
                <form class="form w-100" action="{{ route('password.update') }}" method="post" id="kt_new_password_form">
                    @csrf
                    <!--begin::Heading-->
                        <input type="hidden" name="token" value="{{ request()->route('token') }}">
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Nouveau mot de passe</h1>
                        <!--end::Title-->
                        <!--begin::Link-->
                        <div class="text-gray-400 fw-bold fs-4">Vous avez déja réinitialiser votre mot de passe ?
                            <a href="{{ route('login') }}" class="link-primary fw-bolder">Me connecter</a></div>
                        <!--end::Link-->
                    </div>
                    <!--begin::Heading-->
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        ...
                        <input class="form-control form-control-lg form-control-solid" type="email" name="email" autocomplete="off" value="{{ request()->email }}"/>
                    </div>
                    ...
                    <!--begin::Input group=-->
                    <div class="fv-row mb-10">
                        <label class="form-label fw-bolder text-dark fs-6">Confirmation du mot de passe</label>
