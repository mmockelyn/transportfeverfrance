...
<!--begin::Head-->
<head><base href="">
    <title>TPF France - {{ auth()->user()->name }}</title>
    <meta charset="utf-8" />
    ...
    <link href="/account/assets/plugins/global/plugins.dark.bundle.css" rel="stylesheet" type="text/css" />
    <link href="/account/assets/css/style.dark.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Global Stylesheets Bundle-->
</head>
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="background-image: url('/account/assets/media/misc/page-bg-dark.jpg')" class="dark-mode page-bg header-fixed header-tablet-and-mobile-fixed aside-enabled">
<!--begin::Main-->
<!--begin::Root-->
                ...
                <div class="header-container container-xxl d-flex align-items-center">
                    ...
                    <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                        <a href="{{ route('account.dashboard') }}">
                            <img alt="Logo" src="/storage/files/shares/core/logo_carre_couleur.png" class="d-none d-lg-block h-30px" />
                            <img alt="Logo" src="/storage/files/shares/core/logo_carre_couleur.png" class="d-lg-none h-25px" />
                        </a>
                    </div>
                    <!--end::Header Logo-->
                    <!--begin::Wrapper-->
                            ...
                            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-3 ms-lg-5">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                        <!--begin::Heading-->
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('/account/assets/media/misc/pattern-1.png')">
                                            <!--begin::Title-->
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                                ...
                                                <div class="py-3 text-center border-top">
                                                    <a href="../../demo12/dist/pages/profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
                                ...
                                <div class="d-flex align-items-center ms-3 ms-lg-5" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        @if(auth()->user()->avatar)
                                        <img class="h-100 w-100 rounded" src="{{ auth()->user()->avatar }}" alt="" />
                                        @else
                                            <div class="symbol symbol-circle symbol-50px">
                                                <div class="symbol-label fs-2 fw-bold text-white">{{ \Illuminate\Support\Str::limit(auth()->user()->name, 1, '') }}</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--begin::Menu-->
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-xxl d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        <span class="text-gray-700 fw-bold me-1">{{ \Carbon\Carbon::now()->year }}©</span> {{ config('app.name') }}
                    </div>
                    <!--end::Copyright-->
                </div>
                <!--end::Container-->
