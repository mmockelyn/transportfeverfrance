...
@section("content")
    ...
    <div class="row gy-5 g-xl-8 d-flex align-items-center mt-lg-0 mb-10 mb-lg-15">
        ...
        <div class="col-xl-6 d-flex align-items-center">
            <h1 class="fs-2hx">Mes notifications</h1>
        ...
        <div class="col-xl-6">
            <div class="d-flex flex-stack ps-lg-20">
                ...
                <a href="{{ route('account.notify') }}" class="btn btn-icon btn-outline btn-nav active h-50px w-50px h-lg-70px w-lg-70px ms-2" data-bs-toggle="tooltip" title="Mes Notifications">
        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <button id="btnAllMark" class="btn btn-sm btn-success font-weight-bold mr-2">
                        <span class="indicator-label"><i class="flaticon2-check-mark"></i> Marquer comme lu </span>
                        <span class="indicator-progress">Veuillez patienter...
                                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                    </span>
                    </button>
                    <button id="btnAllTrash" class="btn btn-sm btn-danger font-weight-bold">
                        <span class="indicator-label"><i class="fas fa-trash"></i> Tous supprimer</span>
                        <span class="indicator-progress">Veuillez patienter...
                                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                    </span>
                    </button>
