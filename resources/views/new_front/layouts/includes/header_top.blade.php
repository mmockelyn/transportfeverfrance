                    ...
                    <nav class="header-nav-top">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show">
                                <span class="ws-nowrap"><i class="fas fa-envelope"></i> contact@transportfeverfrance.fr</span>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="header-column justify-content-end">
                <div class="header-row">
                    <ul class="header-social-icons social-icons d-none d-sm-block social-icons-clean">
                        <li class="social-icons-facebook"><a href="{{ \App\Helpers\SiteHelper::getSiteInfo('facebook_link') }}" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                        <li class="social-icons-twitter"><a href="{{ \App\Helpers\SiteHelper::getSiteInfo('twitter_link') }}" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
